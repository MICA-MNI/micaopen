...
>>>>>>> 7ae0d61751806133976585704cf4466e92885f5b
        ...
        ###########################################################################################################
            ...
            trialList_sem = data.importConditions('semantic/sem1_List' + expInfo['list'] + '.csv')
            trialList_sem1 = trialList_sem[0:24]
            trialList_sem2 = trialList_sem[24:48]
            ...
            fix_dur_sem1 = [5.5 + (x * fix_increment_sem1) for x in range_trial_sem1]
            
            n_trial_sem2 = len(trialList_sem2)
            fix_increment_sem2 = 1 / (n_trial_sem2 - 1)
            range_trial_sem2 = range(0, n_trial_sem2)
            fix_dur_sem2 = [5.5 + (x * fix_increment_sem2) for x in range_trial_sem2]
            ...
            if spatial2:
                ...
                if prevRuns:
                    ...
                    spa2_csvFile = rootLog + '/sub-' + expInfo['ID'] + '_ses-' + expInfo['session'] + task_lab + \
                                   '_run-01.csv'
...
>>>>>>> 7ae0d61751806133976585704cf4466e92885f5b
            ...
            if semantic2:
                ...
                if prevRuns:
                    ...
                    sem2_csvFile = rootLog + '/sub-' + expInfo['ID'] + '_ses-' + expInfo['session'] + task_lab + \
                                   '_run-01.csv'
