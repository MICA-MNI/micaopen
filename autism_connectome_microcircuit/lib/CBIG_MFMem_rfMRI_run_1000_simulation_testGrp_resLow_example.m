function CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resLow_example(save_dir_input,FCSC_file_name,parameter_file_name)

%--------------------------------------------------------------------------
% CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resLow
%
% Input parameters:
%
%       save_dir_input: Output file directory
%       datafile_name: Name of the data file containing FC and SC matrix
%
% Example: 
%
