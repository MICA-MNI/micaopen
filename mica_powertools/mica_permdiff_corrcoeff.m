function [zdiff_a, abs_corr_diff,perm_corr_diff_p] = gretna_permdiff_corrcoeff(group1, group2, num_rand)
% function [abs_corr_diff,perm_corr_diff_p] = gretna_permdiff_corrcoeff(group1, group2, num_rand)
