function [data keep] = SurfStatReadDataTry( filenames, dirname, maxmem )

%Reads data (e.g. thickness) from an array of .txt or FreeSurfer files. 
% will skip files that do no exist and print them out, stores success (0,1) in keep
%
% Usage: [data keep ]= SurfStatReadData( filenames [, dirname [, maxmem ]] );
%
...
% keep = n x 1 vector, shows success
