...
**03_surfToMPC.m**: Imports data to matlab and builds microstructure profile covariance matrices. Set up to be used with the 1012 parcellation scheme.
...
## Extra features
Atlas for levels of laminar differentiation (a la Mesulam 2001) with 1012 parcellation scheme.
SJH 1012 parcellation scheme - freesurfer annotation on fsaverage7
