...
#############################################################################################################################################################################################
if os.path.isdir('tasks/semantic/data_score') == False:
    os.makedirs('tasks/semantic/data_score')

csv_file = ("tasks/semantic/data_score/" + expInfo['subject name'] + "_" + expInfo['session'] + "_" + expInfo['date'] + "_" +  expInfo['symbol list'] + "_SCORE" + ".csv")
