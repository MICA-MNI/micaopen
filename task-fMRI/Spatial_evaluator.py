...
#############################################################################################################################################################################################
if os.path.isdir("tasks/spatial/data_score") == False:
    os.makedirs("tasks/spatial/data_score") 

csv_file = ("tasks/spatial/data_score/" + expInfo['subject name'] + "_" + expInfo['session'] + "_" + expInfo['date'] + "_" +  expInfo['symbol list'] + "_SCORE" + ".csv")
