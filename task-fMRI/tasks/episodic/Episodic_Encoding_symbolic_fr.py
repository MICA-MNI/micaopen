...
if not os.path.isdir('tasks/episodic/data_encoding'):
    os.makedirs('tasks/episodic/data_encoding')

filename = 'tasks/episodic/data_encoding/' + os.path.sep + '%s_%s' %(expInfo['nom du sujet'], expInfo['date'])
...
###################################################################################################################################################################################
csv_file = ("tasks/episodic/data_encoding/" + expInfo['nom du sujet'] + "_" + expInfo['session'] + "_" + expInfo['date'] + "_" +  expInfo['liste symbolique'] + ".csv")
...
if expInfo['liste symbolique']=='A':
    trialList = data.importConditions("tasks/episodic/Episodic_Encoding_symbolic/Episodic_ListA.csv")
elif expInfo['liste symbolique']=='B':
    trialList = data.importConditions("tasks/episodic/Episodic_Encoding_symbolic/Episodic_ListB.csv")
elif expInfo['liste symbolique']=='démo':
    trialList = data.importConditions("tasks/episodic/Episodic_Encoding_symbolic/Episodic_Listdemo.csv")

LIST = range(len(trialList))

num = range(0,84)

uber_list = list(zip(LIST, LIST, num))
