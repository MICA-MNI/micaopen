...
filename = 'tasks/episodic/data_encoding/' + os.path.sep + '%s_%s' %(expInfo['subject name'], expInfo['date'])
...
###################################################################################################################################################################################
csv_file = ("tasks/episodic/data_encoding/" + expInfo['subject name'] + "_" + expInfo['session'] + "_" + expInfo['date'] + "_" +  expInfo['symbol list'] + ".csv")
...
def instruction(inst_txt='tasks/episodic/Instructions/exp_instr_symbolic.txt'):
...
instruction(inst_txt='tasks/episodic/Instructions/exp_instr_symbolic.txt')
