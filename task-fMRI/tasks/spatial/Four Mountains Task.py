...
instruction(inst_txt='FourMountains_Instructions/exp_instr.txt')
myClock = core.Clock()
...
def instruction(inst_txt='FourMountains_Instructions/exp_instr.txt'):
...
def show_meta():
    meta_description = open('FourMountains_Instructions/meta_instr.txt', 'r').read()
...
def endExp(f):
    endtxt = open('FourMountains_Instructions/end_instr.txt', 'r').read().split('#\n')[0]
