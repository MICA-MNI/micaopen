...
filename = 'tasks/semantic/data/' + os.path.sep + '%s_%s' %(expInfo['subject name'], expInfo['date'])
...
###################################################################################################################################################################################
csv_file = ("tasks/semantic/data/" + expInfo['subject name'] + "_" + expInfo['session'] + "_" + expInfo['date'] + "_" +  expInfo['symbol list'] + ".csv")
...
def instruction(inst_txt='tasks/semantic/Instructions/exp_instr_symbolic.txt'):
...
instruction(inst_txt='tasks/semantic/Instructions/exp_instr_symbolic.txt')
...
def end(end_txt='tasks/semantic/Instructions/end_instr.txt'):
...
end(end_txt='tasks/semantic/Instructions/end_instr.txt')
