...
def instruction(inst_txt='tasks/MST/Instructions/exp_instr2.txt'):
...
instruction(inst_txt='tasks/MST/Instructions/exp_instr2.txt')
...
########################################################################
instrTxt.setText(open('tasks/MST/Instructions/wait_trigger.txt', 'r').read())
instrTxt.draw()
win.flip()
core.wait(2)
...
for i,j in exp_list:
	...
	old_sim_new.setText(open('tasks/MST/Instructions/old_sim_new.txt', 'r').read())
	#
...
def end(end_txt='tasks/MST/Instructions/end_instr.txt'):
...
end(end_txt='tasks/MST/Instructions/end_instr.txt')
