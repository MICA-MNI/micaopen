...
def instruction(inst_txt='tasks/MST/Instructions/exp_instr.txt'):
...
instruction(inst_txt='tasks/MST/Instructions/exp_instr.txt')
...
for i,j in exp_list:
	...
	in_out.setText(open('tasks/MST/Instructions/in_out.txt', 'r').read())
	#
