...
isPractice = True      # give subject feedback when they get it wrong?
blockLengths = [8] # how many trials in each block? The length of this list will be the number of blocks.
