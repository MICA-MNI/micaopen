...
def instruction(inst_txt='tasks/fixation/Instructions/exp_instr_mv_fr.txt'):
...
instruction(inst_txt='tasks/fixation/Instructions/exp_instr_mv_fr.txt')
...
def end(end_txt='tasks/fixation/Instructions/end_instr_fr.txt'):
...
end(end_txt='tasks/fixation/Instructions/end_instr_fr.txt')
